...
separator.style.background = 'rgba(255, 255, 255, 0.5)'; // Set separator background color
...
displayBox.style.background = 'rgba(255, 255, 255, 0.2)'; // Set display box background color
displayBox.style.borderRadius = '16px'; // Set display box border radius
displayBox.style.boxShadow = '0 4px 30px rgba(0, 0, 0, 0.1)'; // Add box shadow to display box
...
displayBox.style.color = 'white'; // Set display box text color
